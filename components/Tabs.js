      ...
      <div className="tab-content " id="pills-tabContent">
        ...
        >
          <p className="text-light fs-5 text-center mx-5">
            ...
            fácil acceso con beneficios para el empoderamiento colectivo de los
            usuarios y su capitalización.
          </p>
        </div>
        <div
          class="tab-pane fade"
        ...
        >
          <p className="text-light fs-5 text-center mx-5">
            ...
            otras opciones para contrarrestar los efectos negativos económicos y
            sociales como los que hoy se manifiestan a nivel local y regional.
          </p>
        </div>
